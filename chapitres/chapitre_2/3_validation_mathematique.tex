...
Le notebook compare ensuite six seuils de réaffectation, de 0 à 0,50, avec la stratégie \texttt{embeddings} de BERTopic. Le seuil de 0,20 conserve les 17 topics et réattribue \(46\,952\) des \(46\,965\) documents atypiques. Treize segments demeurent étiquetés \texttt{-1}, ce qui porte la couverture finale à \(99{,}98\,\%\). Les topics comptent alors entre \(1\,339\) et \(7\,588\) segments, avec une médiane de \(2\,999\) ; le plus grand rassemble \(12{,}4\,\%\) des documents assignés.
...
\subsection{Cohérence et diversité lexicales}
