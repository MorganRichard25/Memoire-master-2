...
Le chapitre suivant déplacera ainsi l'analyse de l'exploration non supervisée vers l'apprentissage statistique sur un corpus réunissant Zola, d'autres auteurs naturalistes et des auteurs non naturalistes. Une régression linéaire pourra mesurer l'association entre des caractéristiques textuelles et une variable continue, telle que la fréquence d'un motif ; si la variable à prédire est directement l'appartenance binaire au naturalisme, une régression logistique sera plus adaptée. Une modélisation bayésienne, idéalement hiérarchique, permettra de quantifier l'incertitude et de tenir compte de l'imbrication des segments dans les œuvres et des œuvres dans les auteurs, ainsi que des effets de période et de longueur. La séparation des auteurs et des romans entre apprentissage et évaluation sera enfin indispensable pour éviter qu'un modèle présenté comme détecteur du naturalisme n'apprenne seulement à reconnaître Zola ou quelques œuvres particulières.
